...
app = Flask(__name__)
app.secret_key = "SUPER-SECRET"  # Ensure this key is kept secret in production
limiter = Limiter(app=app, key_func=get_remote_address, default_limits=["10 per minute"], storage_uri="memory://")
